...
# Configure hosts
echo "[master]" | sudo tee /opt/ibm-cloud-private-3.1.0/cluster/hosts
echo "${MASTER_IP}" | sudo tee -a /opt/ibm-cloud-private-3.1.0/cluster/hosts
...
echo "${PROXY_IP}" | sudo tee -a /opt/ibm-cloud-private-3.1.0/cluster/hosts
